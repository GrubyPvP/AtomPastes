...
namespace EgguWare.Menu.Tabs
{
    public class MiscTab
    {
        ...
        public static void Tab()
        {
            ...
            G.Settings.MiscOptions.VehicleNoClip = GUILayout.Toggle(G.Settings.MiscOptions.VehicleNoClip, "Vehicle Flight");
            G.Settings.MiscOptions.ShowVanishPlayers = GUILayout.Toggle(G.Settings.MiscOptions.ShowVanishPlayers, "Show Vanished Players");
            G.Settings.MiscOptions.FullBright = GUILayout.Toggle(G.Settings.MiscOptions.FullBright, "Full Bright");
            ...
            G.Settings.MiscOptions.Spam = GUILayout.Toggle(G.Settings.MiscOptions.Spam, "Enable Chat Spam");
            ...
            {
                G.Settings.MiscOptions.LimitFOV = GUILayout.Toggle(G.Settings.MiscOptions.LimitFOV, "FOV Limit");
                if (G.Settings.MiscOptions.LimitFOV)
                {
                    GUILayout.Label("FOV Circle: " + G.Settings.MiscOptions.ItemGrabFOV);
                    G.Settings.MiscOptions.ItemGrabFOV = (int)GUILayout.HorizontalSlider(G.Settings.MiscOptions.ItemGrabFOV, 1, 1200);
                    G.Settings.MiscOptions.DrawFOVCircle = GUILayout.Toggle(G.Settings.MiscOptions.DrawFOVCircle, "Draw FOV Circle");
                }
            }
